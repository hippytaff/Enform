...
/* FIXME: things to add to the slave enform_fm process and ipc to e:
 *
 * * reporting results of fop's (current status - what has been don, what failed etc.)
 * * dbus removable device monitoring (in e17 itself now via e_dbus - move to enform_fm and ipc removable device add/del and anything else)
