...
ACT_FN_GO(exit, )
{
   ...
   e_dialog_text_set(exit_dialog, _("Are you sure you want to exit Enform?"));
...
e_actions_init(void)
{
   ...
   ACT_GO(restart);
   e_action_predef_name_set(N_("Enform"), N_("Restart"), "restart",
                            NULL, NULL, 0);

   ACT_GO(exit);
   e_action_predef_name_set(N_("Enform"), N_("Exit"), "exit",
                            NULL, NULL, 0);

   ACT_GO(exit_now);
   e_action_predef_name_set(N_("Enform"), N_("Exit Now"),
                            "exit_now", NULL, NULL, 0);

   ACT_GO(mode_presentation_toggle);
   e_action_predef_name_set(N_("Enform : Mode"),
   ...
   e_action_predef_name_set(N_("Enform : Module"),
