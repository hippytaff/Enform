   ...
   if (desktop)
     {
        ...
        single = eina_hash_find(desktop->x, "X-Enform-Single-Instance");
        if ((single) ||
        ...
        if (!getcwd(buf, sizeof(buf)))
          {
             ...
             e_util_dialog_show
               (_("Run Error"),
                   _("Enform was unable to get current directory"));
             return NULL;
          }
        if (chdir(desktop->path))
          {
             ...
             e_util_dialog_show
               (_("Run Error"),
                   _("Enform was unable to change to directory:<br>"
                     "<br>"
                     "%s"),
                   desktop->path);
             return NULL;
        ...
        if (chdir(buf))
          {
             e_util_dialog_show
               (_("Run Error"),
                   _("Enform was unable to restore to directory:<br>"
                     "<br>"
                     "%s"),
                   buf);
             free(inst);
   ...
   if (!exe)
     {
        ...
        e_util_dialog_show(_("Run Error"),
                           _("Enform was unable to fork a child process:<br>"
                             "<br>"
                             "%s"),
                           exec);
        return NULL;
             ...
             if (dia)
               {
                  ...
                  snprintf(buf, sizeof(buf),
                           _("Enform was unable to run the application:<br>"
                             "<br>"
                             "%s<br>"
                             "<br>"
