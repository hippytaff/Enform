...
{
   const char *drop_types[] = { "enform/gadcon_client" };
        ...
        if (gcc->gadcon->shelf)
          {
             ...
             e_util_menu_item_theme_icon_set(mi, "enform/plain");
             ...
             e_util_menu_item_theme_icon_set(mi, "enform/inset");
             e_menu_item_radio_group_set(mi, 1);
             e_menu_item_radio_set(mi, 1);
...
_e_gadcon_client_drag_begin(E_Gadcon_Client *gcc, int x, int y)
{
   ...
   Evas_Object *o = NULL;
   Evas_Coord w = 0, h = 0;
   const char *drag_types[] = { "enform/gadcon_client" };
   ...
   if (ev->button == 3)
     {
        ...
        e_util_menu_item_theme_icon_set(mi, "enform/edit");
        e_menu_item_callback_set(mi, _e_gadcon_client_cb_menu_edit, gcc);
