...
main(int argc, char **argv)
{
   ...
   if (!eina_init())
     {
        e_error_message_show(_("Enform cannot initialize Eina!\n"));
        _e_main_shutdown(-1);
     }
   _e_main_shutdown_push(eina_shutdown);
   if (!e_log_init())
     {
        e_error_message_show(_("Enform could not create a logging domain!\n"));
        _e_main_shutdown(-1);
     }
#ifdef TS_DO
#undef TS
# define TS(x)                                               \
  {                                                          \
   ...
   if (!e_prefix_determine(argv[0]))
     {
        fprintf(stderr,
                "ERROR: Enform cannot determine it's installed\n"
   ...
   e_util_env_set("DESKTOP", "Enform-0.17.0");
   ...
   if (!eet_init())
     {
        e_error_message_show(_("Enform cannot initialize Eet!\n"));
        _e_main_shutdown(-1);
     }
   TS("Eet Init Done");
   ...
   if (!ecore_init())
     {
        e_error_message_show(_("Enform cannot initialize Ecore!\n"));
        _e_main_shutdown(-1);
     }
   TS("Ecore Init Done");
   ...
   if (!eio_init())
     {
        e_error_message_show(_("Enform cannot initialize EIO!\n"));
        _e_main_shutdown(-1);
     }
   TS("EIO Init Done");
   ...
   if (!ecore_event_handler_add(ECORE_EVENT_SIGNAL_EXIT,
     ...
     {
        e_error_message_show(_("Enform cannot set up an exit signal handler.\n"
   ...
   if (!ecore_event_handler_add(ECORE_EVENT_SIGNAL_HUP,
     ...
     {
        e_error_message_show(_("Enform cannot set up a HUP signal handler.\n"
                               "Perhaps you are out of memory?"));
        _e_main_shutdown(-1);
     }
   if (!ecore_event_handler_add(ECORE_EVENT_SIGNAL_USER,
     ...
     {
        e_error_message_show(_("Enform cannot set up a USER signal handler.\n"
                               "Perhaps you are out of memory?"));
        _e_main_shutdown(-1);
     }
   ...
   if (!ecore_file_init())
     {
        e_error_message_show(_("Enform cannot initialize Ecore_File!\n"));
        _e_main_shutdown(-1);
     }
   ...
   if (!ecore_con_init())
     {
        e_error_message_show(_("Enform cannot initialize Ecore_Con!\n"));
        _e_main_shutdown(-1);
     }
   ...
   if (!ecore_ipc_init())
     {
        e_error_message_show(_("Enform cannot initialize Ecore_Ipc!\n"));
        _e_main_shutdown(-1);
     }
   ...
   if (!ecore_x_init(NULL))
     {
        e_error_message_show(_("Enform cannot initialize Ecore_X!\n"));
        _e_main_shutdown(-1);
     }
   ...
   if (!ecore_imf_init())
     {
        e_error_message_show(_("Enform cannot initialize Ecore_IMF!\n"));
        _e_main_shutdown(-1);
     }
   ...
   if (!ecore_evas_init())
     {
        e_error_message_show(_("Enform cannot initialize Ecore_Evas!\n"));
        _e_main_shutdown(-1);
     }
...
//   _e_main_shutdown_push(ecore_evas_shutdown);
   ...
   if (!elm_init(argc, argv))
     {
        e_error_message_show(_("Enform cannot initialize Elementary!\n"));
        _e_main_shutdown(-1);
     }
   ...
   if (!emotion_init())
     {
        e_error_message_show(_("Enform cannot initialize Emotion!\n"));
        _e_main_shutdown(-1);
     }
   ...
   if (!ecore_evas_engine_type_supported_get(ECORE_EVAS_ENGINE_SOFTWARE_XCB))
     {
        if (!ecore_evas_engine_type_supported_get(ECORE_EVAS_ENGINE_SOFTWARE_XLIB))
          {
             e_error_message_show(_("Enform found ecore_evas doesn't support the Software X11\n"
   ...
   if (!ecore_evas_engine_type_supported_get(ECORE_EVAS_ENGINE_SOFTWARE_BUFFER))
     {
        e_error_message_show(_("Enform found ecore_evas doesn't support the Software Buffer\n"
                               "rendering in Evas. Please check your installation of Evas and\n"
   ...
   if (!edje_init())
     {
        e_error_message_show(_("Enform cannot initialize Edje!\n"));
        _e_main_shutdown(-1);
     }
   TS("Edje Init Done");
   ...
   if (!e_intl_init())
     {
        e_error_message_show(_("Enform cannot initialize E_Intl!\n"));
        _e_main_shutdown(-1);
     }
   TS("E Intl Init Done");
   ...
   if (!e_alert_init())
     {
        e_error_message_show(_("Enform cannot initialize its emergency alert system.\n"
   ...
   if (!_e_main_dirs_init())
     {
        e_error_message_show(_("Enform cannot create directories in your home directory.\n"
   ...
   if (!e_filereg_init())
     {
        e_error_message_show(_("Enform cannot set up its file registry system.\n"));
        _e_main_shutdown(-1);
     }
   ...
   if (!e_config_init())
     {
        e_error_message_show(_("Enform cannot set up its config system.\n"));
        _e_main_shutdown(-1);
     }
   ...
   if (!e_randr_init())
     {
        e_error_message_show(_("Enform cannot initialize E_Randr!\n"));
     }
   else
   ...
   if (!e_xinerama_init())
     {
        e_error_message_show(_("Enform cannot initialize E_Xinerama!\n"));
        _e_main_shutdown(-1);
     }
   ...
   if (!e_env_init())
     {
        e_error_message_show(_("Enform cannot set up its environment.\n"));
        _e_main_shutdown(-1);
     }
   TS("E_Env Init Done");
   ...
   if (!e_scale_init())
     {
        e_error_message_show(_("Enform cannot set up its scale system.\n"));
        _e_main_shutdown(-1);
     }
   ...
   if (!e_pointer_init())
     {
        e_error_message_show(_("Enform cannot set up its pointer system.\n"));
        _e_main_shutdown(-1);
     }
   ...
   if (!_e_main_path_init())
     {
        e_error_message_show(_("Enform cannot set up paths for finding files.\n"
                               "Perhaps you are out of memory?"));
        _e_main_shutdown(-1);
     }
   ...
   if (!e_font_init())
     {
        e_error_message_show(_("Enform cannot set up its font system.\n"));
        _e_main_shutdown(-1);
     }
   TS("E_Font Init Done");
   ...
   if (!e_theme_init())
     {
        e_error_message_show(_("Enform cannot set up its theme system.\n"));
        _e_main_shutdown(-1);
     }
   ...
   if (e_config->show_splash)
     {
        ...
        if (!e_init_init())
          {
             e_error_message_show(_("Enform cannot set up its init screen.\n"));
             _e_main_shutdown(-1);
          }
   ...
   if (!e_intl_post_init())
     {
        e_error_message_show(_("Enform cannot set up its intl system.\n"));
        _e_main_shutdown(-1);
     }
   ...
   if (!efreet_init())
     {
        e_error_message_show(_("Enform cannot initialize the FDO desktop system.\n"
   ...
   if (!_e_main_screens_init())
     {
        e_error_message_show(_("Enform set up window management for all the screens on your system\n"
   ...
   if (!e_backlight_init())
     {
        e_error_message_show(_("Enform cannot configure the backlight.\n"));
        _e_main_shutdown(-1);
     }
   ...
   if (!e_screensaver_init())
     {
        e_error_message_show(_("Enform cannot configure the X screensaver.\n"));
        _e_main_shutdown(-1);
     }
   ...
   if (!e_dpms_init())
     {
        e_error_message_show(_("Enform cannot configure the DPMS settings.\n"));
        _e_main_shutdown(-1);
     }
   TS("E_Dpms Init Done");
   ...
   if (!e_powersave_init())
     {
        e_error_message_show(_("Enform cannot set up its powersave modes.\n"));
        _e_main_shutdown(-1);
     }
   ...
   if (!e_desklock_init())
     {
        e_error_message_show(_("Enform cannot set up its desk locking system.\n"));
        _e_main_shutdown(-1);
     }
   ...
   if (!e_popup_init())
     {
        e_error_message_show(_("Enform cannot set up its popup system.\n"));
        _e_main_shutdown(-1);
     }
   ...
   if (!e_sys_init())
     {
        e_error_message_show(_("Enform cannot initialize the System Command system.\n"));
        _e_main_shutdown(-1);
     }
   TS("E_Sys Init Done");
   ...
   if (!e_actions_init())
     {
        e_error_message_show(_("Enform cannot set up its actions system.\n"));
        _e_main_shutdown(-1);
     }
   ...
   if (!e_exec_init())
     {
        e_error_message_show(_("Enform cannot set up its exec system.\n"));
        _e_main_shutdown(-1);
     }
   TS("E_Exec Init Done");
   ...
   if (!e_fm2_init())
     {
        e_error_message_show(_("Enform cannot initialize the File manager.\n"));
        _e_main_shutdown(-1);
     }
   TS("E_Fm2 Init Done");
   ...
   if (!e_msg_init())
     {
        e_error_message_show(_("Enform cannot set up its msg system.\n"));
        _e_main_shutdown(-1);
     }
   TS("E_Msg Init Done");
   ...
   if (!e_dnd_init())
     {
        e_error_message_show(_("Enform cannot set up its dnd system.\n"));
        _e_main_shutdown(-1);
     }
   TS("E_Dnd Init Done");
   ...
   if (!e_grabinput_init())
     {
        e_error_message_show(_("Enform cannot set up its grab input handling system.\n"));
        _e_main_shutdown(-1);
     }
   ...
   if (!e_module_init())
     {
        e_error_message_show(_("Enform cannot set up its module system.\n"));
        _e_main_shutdown(-1);
     }
   ...
   if (!e_remember_init(after_restart ? E_STARTUP_RESTART : E_STARTUP_START))
     {
        e_error_message_show(_("Enform cannot setup remember settings.\n"));
        _e_main_shutdown(-1);
     }
   ...
   if (!e_color_class_init())
     {
        e_error_message_show(_("Enform cannot set up its color class system.\n"));
        _e_main_shutdown(-1);
     }
   ...
   if (!e_gadcon_init())
     {
        e_error_message_show(_("Enform cannot set up its gadget control system.\n"));
        _e_main_shutdown(-1);
     }
   ...
   if (!e_bg_init())
     {
        e_error_message_show(_("Enform cannot set up its desktop background system.\n"));
        _e_main_shutdown(-1);
     }
   TS("E_Bg Init Done");
   ...
   if (!e_mouse_update())
     {
        e_error_message_show(_("Enform cannot configure the mouse settings.\n"));
        _e_main_shutdown(-1);
     }
   ...
   if (!e_xkb_init())
     {
        e_error_message_show(_("Enform cannot setup XKB Keyboard layouts.\n"));
        _e_main_shutdown(-1);
     }
   TS("E_Xkb Init Done");
   ...
   if (!e_bindings_init())
     {
        e_error_message_show(_("Enform cannot set up its bindings system.\n"));
        _e_main_shutdown(-1);
     }
   ...
   if (!e_thumb_init())
     {
        e_error_message_show(_("Enform cannot initialize the Thumbnailing system.\n"));
        _e_main_shutdown(-1);
     }
   ...
   if (!e_icon_init())
     {
        e_error_message_show(_("Enform cannot initialize the Icon Cache system.\n"));
        _e_main_shutdown(-1);
     }
   TS("E_Icon Init Done");
   ...
   if (!e_xsettings_init())
     {
        e_error_message_show(_("Enform cannot initialize the XSettings system.\n"));
        _e_main_shutdown(-1);
     }
   ...
   if (!e_update_init())
     {
        e_error_message_show(_("Enform cannot initialize the Update system.\n"));
        _e_main_shutdown(-1);
     }
   ...
   if (!e_deskenv_init())
     {
        e_error_message_show(_("Enform cannot initialize its desktop environment.\n"));
        _e_main_shutdown(-1);
     }
   ...
   if (!e_order_init())
     {
        e_error_message_show(_("Enform cannot set up its order file system.\n"));
        _e_main_shutdown(-1);
     }
...
_e_main_parse_arguments(int argc, char **argv)
{
   ...
   /* we want to have been launched by enform_start. there is a very */
   /* good reason we want to have been launched this way, thus check */
   if (!getenv("E_START"))
     {
        e_error_message_show(_("You are executing enform directly. This is\n"
                               "bad. Please do not execute the \"enform\"\n"
                               "binary. Use the \"enform_start\" launcher. It\n"
                               "will handle setting up environment variables, paths,\n"
                               "and launching any other required services etc.\n"
                               "before enform itself begins running.\n"));
        _e_main_shutdown(-1);
     }
}
...
_e_main_path_init(void)
{
   ...
   snprintf(buf, sizeof(buf), "%s/enform/modules", e_prefix_lib_get());
   e_path_default_path_append(path_modules, buf);
    ...
    */
   snprintf(buf, sizeof(buf), "%s/enform/modules_extra", e_prefix_lib_get());
   e_path_default_path_append(path_modules, buf);
...
_e_main_test_formats(void)
{
   ...
   if (!(ee = ecore_evas_buffer_new(1, 1)))
     {
        e_error_message_show(_("Enform found Evas can't create a buffer canvas. Please check\n"
   ...
   if (evas_object_image_load_error_get(im) != EVAS_LOAD_ERROR_NONE)
     {
        e_error_message_show(_("Enform found Evas can't load SVG files. "
   ...
   if (evas_object_image_load_error_get(im) != EVAS_LOAD_ERROR_NONE)
     {
        e_error_message_show(_("Enform found Evas can't load JPEG files. "
   ...
   if (evas_object_image_load_error_get(im) != EVAS_LOAD_ERROR_NONE)
     {
        e_error_message_show(_("Enform found Evas can't load PNG files. "
   ...
   if (evas_object_image_load_error_get(im) != EVAS_LOAD_ERROR_NONE)
     {
        e_error_message_show(_("Enform found Evas can't load EET files. "
   ...
   if ((tw <= 0) && (th <= 0))
     {
        e_error_message_show(_("Enform found Evas can't load the 'Sans' font. Check Evas has fontconfig\n"
        ...
        if ((crashmodule) && (m))
          {
             ...
             e_error_message_show
               (_("Enform crashed early on start and has<br>"
             ...
             e_util_dialog_show
               (_("Enform crashed early on start and has been restarted"),
               _("Enform crashed early on start and has been restarted.<br>"
