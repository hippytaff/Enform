   ...
   EINA_LIST_FOREACH(settings_desktops, l, desktop)
     {
        ...
        if (desktop->x)
          {
             cfg_cat_cfg = eina_hash_find(desktop->x, "X-Enform-Config-Category");
             s = eina_hash_find(desktop->x, "X-Enform-Config-Priority");
             if (s) cfg_pri = atoi(s);
             cfg_cat_name = eina_hash_find(desktop->x, "X-Enform-Config-Category-Name");
             cfg_cat_icon = eina_hash_find(desktop->x, "X-Enform-Config-Category-Icon");
