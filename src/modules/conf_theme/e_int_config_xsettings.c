...
struct _E_Config_Dialog_Data
{
   ...
   struct
   {
      ...
      Evas_Object *icon_enable_enform;
   } gui;
...
_settings_changed(void *data, Evas_Object *obj EINA_UNUSED)
{
   ...
   e_widget_disabled_set(cfdata->gui.icon_enable_enform, disable);
...
_basic_create(E_Config_Dialog *cfd, Evas *evas, E_Config_Dialog_Data *cfdata)
{
   ...
   cfdata->gui.match_theme = ow = e_widget_check_add(evas, _("Match Enform theme if possible"),
   ...
   cfdata->gui.icon_enable_enform = ow = e_widget_check_add(evas, _("Enable icon theme for Enform"),
