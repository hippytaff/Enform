...
_signal_add_show(E_Config_Dialog_Data *cfdata)
{
   ...
   e_dialog_icon_set(cfdata->locals.dia, "enform/signals", 48);
...
_basic_create_widgets(E_Config_Dialog *cfd, Evas *evas, E_Config_Dialog_Data *cfdata)
{
   ...
   ob = e_widget_button_add(evas, _("Restore Default Bindings"), "enform", _restore_signal_binding_defaults_cb, cfdata, NULL);
