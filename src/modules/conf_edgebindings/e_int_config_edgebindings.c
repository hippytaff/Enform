...
_basic_create_widgets(E_Config_Dialog *cfd, Evas *evas, E_Config_Dialog_Data *cfdata)
{
   ...
   ob = e_widget_button_add(evas, _("Restore Default Bindings"), "enform", _restore_edge_binding_defaults_cb, cfdata, NULL);
   ...
   for (l = cfdata->binding.edge, i = 0; l; l = l->next, i++)
     {
        ...
        e_util_edje_icon_set(ic, "enform/edges");
...
_edge_grab_wnd_show(E_Config_Dialog_Data *cfdata)
{
   ...
   e_dialog_icon_set(cfdata->locals.dia, "enform/edges", 48);
