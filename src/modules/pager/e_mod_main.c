...
_gc_init(E_Gadcon *gc, const char *name, const char *id, const char *style)
{
   ...
   const char *drop[] =
   {
      "enform/pager_win", "enform/border",
      "enform/vdesktop"
   };
...
_pager_window_cb_drag_convert(E_Drag *drag, const char *type)
{
   ...
   pw = drag->data;
   if (!strcmp(type, "enform/pager_win")) return pw;
   if (!strcmp(type, "enform/border")) return pw->border;
   return NULL;
}
...
_pager_drop_cb_drop(void *data, const char *type, void *event_info)
{
   ...
   if (pd)
     {
        if (!strcmp(type, "enform/pager_win"))
          {
        ...
        else if (!strcmp(type, "enform/border"))
          {
             bd = ev->data;
        ...
        else if (!strcmp(type, "enform/vdesktop"))
          {
             pd2 = ev->data;
             if (!pd2) return;
...
_pager_desk_cb_mouse_move(void *data, Evas *e __UNUSED__, Evas_Object *obj __UNUSED__, void *event_info)
{
   ...
   Evas_Coord x, y, w, h;
   const char *drag_types[] = { "enform/vdesktop" };
   Pager_Win *pw;
   Eina_List *l;
